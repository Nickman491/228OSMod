...
public class class420 {
    ...
    static void method8237(ArrayList arrayList, int n, int n2, int n3, int n4) {
        ...
        if (bl) return;
        if (class544.field5403.method2896() == 0) return;
        ...
        while (true) {
            ...
            ((ArrayList)object).add(new class345((class391)class544.field5399, (Integer)arrayList.get(n6), 0, class544.field5403.method2896(), false));
            ++n6;
        }
    }
}
