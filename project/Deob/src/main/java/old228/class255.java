...
public class class255 {
    ...
    public static void method5410(String string, Throwable throwable) {
        if (throwable != null) {
        ...
        try {
            ...
            if (throwable != null) {
                ...
                Object object3;
                object2 = throwable;
                if (object2 instanceof class582) {
                    object3 = (class582)object2;
                    string4 = ((class582)object3).field5651 + " | ";
                    object2 = ((class582)object3).field5652;
                } else {
                    string4 = "";
                }
            ...
            string2 = string2.replace('&', '_');
            string2 = string2.replace('#', '_');
            if (class582.field5649 == null) {
                return;
            }
            object = new URL(class582.field5649.getCodeBase(), "clienterror.ws?cv=" + class582.field5650 + "&cs=" + class484.field5050 + "&u=" + class484.field5049 + "&v1=" + class214.field2382 + "&v2=" + class214.field2379 + "&ct=" + class226.field2468 + "&e=" + string2);
