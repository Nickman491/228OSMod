...
public abstract class class482 {
    ...
    static void method9366(int n, int n2, int n3, int n4, int n5, short s, int n6, short s2, int n7, int n8) {
        ...
        while (true) {
            block9: {
                block8: {
                    if (class1092 == null) break block8;
                    if ((n4 & Short.MAX_VALUE) != class1092.field1389 || n5 != class1092.field1385) break block9;
                    class228 class2282 = class1092.method3105();
                    if (class2282 == null) {
                    ...
                    class1092.method3104(class2282);
                }
