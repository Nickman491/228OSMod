...
public class class59 {
    ...
    class59(class41 class4110, boolean bl, int[] nArray, int[] nArray2, boolean[] blArray) {
        this.field403 = class4110;
        this.field399 = bl;
    ...
    void method1195(float[] fArray, int n) {
        ...
        int n3 = class41.field251[this.field403.field245 - 1];
        ...
        while (true) {
            ...
            int n8;
            if (n4 >= n2) {
                this.method1194(0, n2 - 1);
                n4 = 0;
                n8 = this.field403.field245 * this.field401[0];
                n7 = 1;
                while (true) {
                    if (n7 >= n2) {
                        float f = class41.field248[n8];
                        n6 = n4;
                        while (n6 < n) {
                            int n9 = n6++;
                    ...
                    if (this.field406[n7]) {
                        n6 = this.field402[n7];
                        n5 = this.field403.field245 * this.field401[n7];
    ...
    void method1194(int n, int n2) {
        ...
        while (true) {
            if (n6 > n2) {
                ...
                this.field401[n3] = n5;
                this.field406[n3] = bl;
                this.method1194(n, n3 - 1);
                this.method1194(n3 + 1, n2);
                return;
            }
