...
public class class574 {
    ...
    public void method10907(class436 class4362, class435 class4352) {
        int n;
        int n2;
        if (class4352 == null) {
            return;
        }
        int n3 = class4352.field4832;
        ...
        class566.method10659(this.field5609, this.field5598, this.field5599 + this.field5609, this.field5598 + this.field5600);
        ...
        if (!class4403.method8788()) {
            int n12 = class4352.field4846 + class4352.field4847;
            for (n2 = 0; n2 < class4403.method8808(); ++n2) {
                class438 class4382 = class4403.method8786(n2);
                n = n7 + class4382.field4821;
                int n13 = class4352.method8677(class4382.field4824);
                int n14 = n8 + class4382.field4822 - n3;
                class566.method10677(n, n14, n13, n12, this.field5603);
            }
        }
        if (!class4402.method8788()) {
            class4352.method8689(class4402, n7, n8, this.field5606, this.field5607, -1);
        }
        if (!class4403.method8788()) {
            class4352.method8689(class4403, n7, n8, this.field5602, this.field5607, -1);
        }
        if (!class4404.method8788()) {
            class4352.method8689(class4404, n7, n8, this.field5606, this.field5607, -1);
        }
        if (this.field5608) {
            ...
            n = n15 - n4;
            class566.method10623(n2, n15, n2, n, this.field5606);
            if (this.field5607 != -1) {
                class566.method10623(n2 + 1, n15 + 1, n2 + 1, n + 1, this.field5607);
            }
        }
    }
}
