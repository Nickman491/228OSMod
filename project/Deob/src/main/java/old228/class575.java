...
public class class575 {
    ...
    void method10917() {
        this.field5624 = class74.field892.method8682("Choose Option");
        int n = 0;
        while (true) {
            if (n >= this.field5612) {
                this.field5624 += 8;
            ...
            int n2 = class74.field892.method8682(this.method10916(n));
    ...
    public final void method10920(int n, int n2) {
        ...
        if (this.field5620 + this.field5624 > class128.field1521) {
            this.field5620 = class128.field1521 - this.field5624;
        }
        if (this.field5620 < 0) {
            this.field5620 = 0;
        }
        this.field5610 = n2;
        if (this.field5625 * 1569719871 + this.field5610 > class363.field4038) {
            this.field5610 = class363.field4038 - this.field5625 * 1569719871;
        }
        if (this.field5610 < 0) {
            this.field5610 = 0;
        }
    ...
    final void method10915(class575 class5752) {
        ...
        if (this.field5624 + this.field5620 > class128.field1521) {
    ...
    public final void method10921(int n) {
        ...
        class508.method9611(this.field5622[n], this.field5613[n], this.field5614[n], this.field5615[n], this.field5616[n], this.field5617[n], this.field5618[n], this.field5619[n], class35.field209, class35.field211);
    }
        ...
        if (n >= this.field5620 - 10 && n <= this.field5624 + this.field5620 + 10 && n2 >= this.field5610 - 10 && n2 <= this.field5625 * 1569719871 + this.field5610 + 10) {
            ...
            if (n3 != -1 && n3 != this.field5626) {
                if (n3 != this.field5627) {
                    this.field5627 = n3;
                    this.field5621 = class37.method724();
                    if (this.field5626 != -1) {
                        this.field5621 += 300L;
                    }
                }
                if (this.field5621 <= class37.method724()) {
                    this.field5627 = -1;
                    this.method10926();
    ...
    public final void method10932() {
        ...
        int n5 = 0;
        while (true) {
            if (n5 >= client.field711) {
                this.method10926();
                return;
            }
            if (client.field718[n5] + client.field716[n5] > n && client.field716[n5] < n + n3 && client.field611[n5] + client.field605[n5] > n2 && client.field611[n5] < n4 + n2) {
    ...
    public final void method10928() {
        ...
        int n2 = this.field5610;
        int n3 = 6116423;
        class566.method10677(n, n2, this.field5624, this.field5625 * 1569719871, n3);
        if (!this.field5611) {
            class566.method10617(n + 1, n2 + 1, this.field5624 - 2, this.field5625 * 1569719871 - 2, 0);
        } else {
            class566.method10677(n + 1, n2 + 1, this.field5624 - 2, 16, 0);
            class566.method10617(n + 1, n2 + 18, this.field5624 - 2, this.field5625 * 1569719871 - 19, 0);
            class74.field892.method8727("Choose Option", n + 3, n2 + 14, n3, -1);
        }
        int n4 = class35.field201;
        int n5 = class35.field202;
        int n6 = 0;
        while (true) {
            ...
            if (n6 == this.field5626 || n6 == this.field5627 && this.field5623[n6] != null) {
                class566.method10677(n + 2, n7 - 12, this.field5624 - 4, 15, 7496785);
            }
            class74.field892.method8727(this.method10916(n6), n + 3, n7, n8, 0);
            if (this.field5623[n6] != null) {
                class74.field892.method8674(62, n + this.field5624 - 10, n7, 0xFFFFFF);
            }
            ++n6;
        }
    }
