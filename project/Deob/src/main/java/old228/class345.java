...
public class class345 {
    ...
    public class334 field3743;
    @ObfuscatedName(value="as")
    @ObfuscatedSignature(descriptor="Lbs;")
    public class45 field3746;
    @ObfuscatedName(value="aq")
    @ObfuscatedSignature(descriptor="Lnx;")
    public class342 field3747;

    @ObfuscatedSignature(descriptor="(Lpq;Ljava/lang/String;Ljava/lang/String;IZ)V")
    public class345(class391 class3912, String string, String string2, int n, boolean bl) {
        this.field3735 = class3912.method7743(string);
        this.field3737 = class3912.method7747(this.field3735, string2);
        this.method6946(class3912, this.field3735, this.field3737, n, bl);
    }

    @ObfuscatedSignature(descriptor="(Lpq;IIIZ)V")
    public class345(class391 class3912, int n, int n2, int n3, boolean bl) {
        this.method6946(class3912, n, n2, n3, bl);
    }

    @ObfuscatedName(value="ay")
    @ObfuscatedSignature(descriptor="(Lpq;IIIZI)V", garbageValue="-205075161")
    void method6946(class391 class3912, int n, int n2, int n3, boolean bl) {
        this.field3736 = class3912;
        this.field3735 = n;
        this.field3737 = n2;
        this.field3738 = n3;
        this.field3740 = bl;
