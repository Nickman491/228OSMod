...
public final class class428 {
    ...
    public class428(class556 class5562, boolean bl) {
        this.method8417(class5562, bl);
    }
    ...
    void method8417(class556 class5562, boolean bl) {
        if (!bl) {
            for (int i = 0; i < 16; ++i) {
                this.field4761[i] = class5562.method10302();
            }
        } else {
            class429 class4292 = new class429();
            class4292.method8459(class479.method9284(class5562.method10284()));
            class4292.method8460(class479.method9284(class5562.method10284()));
            class4292.method8455(class479.method9284(class5562.method10284()));
            class4292.method8458(class5562.method10284(), class5562.method10284(), class5562.method10284());
