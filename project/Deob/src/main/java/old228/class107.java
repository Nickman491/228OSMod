...
public class class107 {
    ...
    static final void method3094(int n) {
        client.method1954();
        switch (n) {
            case 2: {
                class114.method3212(24);
                class150.method3595("The game servers are currently being updated.", "Please wait a few minutes and try again.", "");
                break;
            }
            case 1: {
                class28.method460();
