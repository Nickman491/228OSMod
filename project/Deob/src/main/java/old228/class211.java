...
extends class226 {
    ...
    public static void method4837() {
        class241.field2583.method6581();
    }

    @ObfuscatedName(value="ay")
    @ObfuscatedSignature(descriptor="(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Lph;I)I", garbageValue="783041897")
    public static int method4838(CharSequence charSequence, CharSequence charSequence2, class406 class4062) {
        char c;
        char c2;
        ...
        do {
                ...
                while (true) {
                    ...
                    if (c2 >= c5) {
                        ...
                        while (true) {
                            ...
                            if (c6 != c8) {
                                return class390.method7724(c6, class4062) - class390.method7724(c8, class4062);
                            }
                            ++c7;
                        }
                    }
                    if (class4062 != class406.field4665) {
                        n3 = n4 = c2;
                    } else {
                        n3 = n - 1 - c2;
                        n4 = n2 - 1 - c2;
                    ...
                    if (c7 != c6 && Character.toUpperCase(c7) != Character.toUpperCase(c6) && (c7 = Character.toLowerCase(c7)) != (c6 = Character.toLowerCase(c6))) {
                        return class390.method7724(c7, class4062) - class390.method7724(c6, class4062);
                    }
                    ++c2;
                }
            }
            ...
            c = class100.method2829(c, class4062);
        } while ((c2 = (char)class100.method2829(c2, class4062)) == c || Character.toUpperCase(c) == Character.toUpperCase(c2) || (c = Character.toLowerCase(c)) == (c2 = Character.toLowerCase(c2)));
        return class390.method7724(c, class4062) - class390.method7724(c2, class4062);
    }

    @ObfuscatedName(value="oy")
    @ObfuscatedSignature(descriptor="(Lna;S)Lna;", garbageValue="3509")
    static class361 method4832(class361 class3612) {
        int n = class232.method5133(class3612);
        int n2 = n >> 17 & 7;
        int n3 = n2;
        if (n3 == 0) {
            return null;
        ...
        int n4 = 0;
        while (n4 < n3) {
            class3612 = class170.field1807.method7031(class3612.field4026);
            if (class3612 == null) {
                return null;
            }
            ++n4;
