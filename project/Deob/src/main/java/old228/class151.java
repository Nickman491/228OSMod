...
extends class150 {
    ...
    void vmethod3879(class556 class5562) {
        this.field1682 = class5562.method10307();
        this.field1679 = class5562.method10282() == 1;
    }
    ...
    void vmethod3882(class161 class1612) {
        class1612.method3687(this.field1682, this.field1679);
    }

    @ObfuscatedName(value="ay")
    @ObfuscatedSignature(descriptor="(I)[Lod;", garbageValue="1838023813")
    public static class385[] method3607() {
        return new class385[]{class385.field4505, class385.field4515, class385.field4511, class385.field4504, class385.field4513, class385.field4507, class385.field4506, class385.field4512, class385.field4500, class385.field4508, class385.field4503, class385.field4514, class385.field4502, class385.field4518, class385.field4509, class385.field4501, class385.field4510};
    }

    @ObfuscatedName(value="ay")
    @ObfuscatedSignature(descriptor="(Lpq;I)V", garbageValue="798078430")
    public static void method3608(class391 class3912) {
        OverlayDef.field2904 = class3912;
    }
