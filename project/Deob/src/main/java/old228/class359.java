...
public class class359 {
    ...
    boolean method7242(class439 class4392) {
        boolean bl = !this.field3834;
        this.field3850.method8663(class4392);
        this.field3829.method8663(class4392);
        this.field3834 = true;
    ...
    boolean method7207(int n) {
        switch (this.field3840) {
            case 2: {
                return class167.method3815((char)n);
            }
            default: {
                return true;
            }
            case 1: {
                return class274.method5930((char)n);
            }
            case 3: {
                return class363.method7571((char)n);
            }
            case 4: 
        }
        char c = (char)n;
        if (!class363.method7571(c)) {
