...
public class class440 {
    ...
    int method8806() {
        ...
        if (this.method8790(class4382)) {
            return this.field4850.field4801.field4827[42];
        }
        int n = this.field4850.field4801.field4827[class4382.field4824];
        if (n != 0) {
            return n;
        }
        if (class4382.field4824 != '\t') {
            return this.field4850.field4801.field4827[32];
        }
        return this.field4850.field4801.field4827[32] * 3;
    }
