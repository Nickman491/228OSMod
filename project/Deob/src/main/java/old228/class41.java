...
public class class41 {
            ...
            while (true) {
                ...
                if (n4 >= n2) {
                    ...
                    while (true) {
                        ...
                        if (n4 >= n3) {
                            int n7;
                            this.field245 = class602.method1205(2) + 1;
    ...
    void method783(int n, int n2, int n3, int n4, float[] fArray, int n5) {
        ...
        n8 -= (n9 < 0 ? -n9 : n9) * n7;
        int n13 = n;
        fArray[n13] = fArray[n13] * field248[n10];
        if (n3 > n5) {
            n3 = n5;
        }
        int n14 = n + 1;
        while (n14 < n3) {
            ...
            int n15 = n14++;
            fArray[n15] = fArray[n15] * field248[n10];
        }
        return;
    }
    ...
    class59 method787(class60 class602) {
        ...
        n = field251[this.field245 - 1];
        int n3 = class320.method6612(n - 1);
        ...
        while (n5 < this.field249.length) {
            ...
            int n10 = 0;
            if (n8 > 0) {
                n10 = class54.field363[this.field246[n6]].method1110(class602);
            }
            for (int i = 0; i < n7; ++i) {
                int n11 = this.field252[n6][n10 & n9];
                n10 >>>= n8;
                class592.field401[n4++] = n11 >= 0 ? class54.field363[n11].method1110(class602) : 0;
            }
            ++n5;
        }
        return class592;
