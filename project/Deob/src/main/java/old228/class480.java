...
implements class67 {
    ...
    void method9300(class274 class2742, int n, int n2) {
        ...
        while (true) {
            if (n3 <= 0) {
                this.field5032[0].field5037.method5899(class2742);
                this.field5032[0].field5038 = client.field514;
                return;
            }
    ...
    static final void method9354(int n, int n2, int n3, int n4, int n5) {
        class283.field3094[0].method10710(n, n2);
        class283.field3094[1].method10710(n, n4 + n2 - 16);
        class566.method10677(n, n2 + 16, 16, n4 - 32, client.field582);
        int n6 = n4 * (n4 - 32) / n5;
        if (n6 < 8) {
            n6 = 8;
        }
        int n7 = (n4 - 32 - n6) * n3 / (n5 - n4);
        class566.method10677(n, n7 + n2 + 16, 16, n6, client.field583);
        class566.method10621(n, n7 + n2 + 16, n6, client.field550);
        class566.method10621(n + 1, n7 + n2 + 16, n6, client.field550);
        class566.method10619(n, n7 + n2 + 16, 16, client.field550);
        class566.method10619(n, n7 + n2 + 17, 16, client.field550);
        class566.method10621(n + 15, n7 + n2 + 16, n6, client.field584);
        class566.method10621(n + 14, n7 + n2 + 17, n6 - 1, client.field584);
        class566.method10619(n, n6 + n7 + n2 + 15, 16, client.field584);
        class566.method10619(n + 1, n7 + n6 + n2 + 14, 15, client.field584);
    }
}
