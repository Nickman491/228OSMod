...
public class class271 {
    ...
    @ObfuscatedSignature(descriptor="[Lkn;")
    static final class271[] field3009 = class71.method2105();
    ...
    static void method5839(SequenceDef class2652, int n, int n2, int n3, boolean bl) {
        if (client.field748 >= 50) {
            return;
        }
        if (class2652.field2925 == null) return;
        if (!class2652.field2925.containsKey(n)) {
            return;
        }
        ArrayList arrayList = (ArrayList)class2652.field2925.get(n);
        ...
        while (true) {
            block12: {
                ...
                if (n5 == 0 && class544.field5403.method2898() == 0) {
                    return;
                }
