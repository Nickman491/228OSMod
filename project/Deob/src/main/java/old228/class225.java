...
public class class225 {
    ...
    void method5051(JSONObject jSONObject, int n, URLLoader class1182) {
        ...
        try {
            this.method5050(jSONObject2.getJSONArray("crmcomponents"), this.field2456, class1182);
        }
        catch (Exception exception) {
            return;
        }
    ...
    void method5050(JSONArray jSONArray, int n, URLLoader class1182) throws JSONException {
        if (jSONArray == null) {
            return;
        }
        for (int i = 0; i < jSONArray.length(); ++i) {
            ...
            try {
                class2232.method5007(jSONObject, n, class1182);
            }
            catch (Exception exception) {
                // empty catch block
            }
