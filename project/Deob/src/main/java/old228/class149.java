...
extends class150 {
    ...
    void vmethod3879(class556 class5562) {
        this.field1677 = class5562.method10307();
    }
    ...
    void vmethod3882(class161 class1612) {
        class1612.method3692(this.field1677);
    }

    @ObfuscatedName(value="ay")
    @ObfuscatedSignature(descriptor="(Lpq;II)Lnb;", garbageValue="1271589655")
    static class338 method3586(class391 class3912, int n) {
        byte[] byArray = class3912.method7735(n);
        if (byArray == null) {
            return null;
        }
        return new class338(byArray);
    }
