...
implements MouseWheel {
    ...
    public Object method10123(class556 class5562) {
        return this.field5397.vmethod10140(class5562);
    }
    ...
    static class81 method10135(int n, int n2, int n3) {
        int n4 = class241.method5261(n2, n);
        class81 class812 = class158.method3668(n4, n);
        if (class812 == null) {
            int n5 = (-3 - n3 << 8) + n;
            n4 = n5;
            class812 = class158.method3668(n4, n);
            if (class812 == null) {
    ...
    public static void method10136(Object object, class556 class5562) {
        ...
        object2 = class5402;
        object2.vmethod10147(object, class5562);
    }

    @ObfuscatedName(value="mm")
    @ObfuscatedSignature(descriptor="(B)Z", garbageValue="109")
    static boolean method10137() {
        return client.field734;
    }
}
