...
extends class510 {
    ...
    class144(class391 class3912, class391 class3913, int n, boolean bl) {
        this.field1643 = n;
        byte[] byArray = class3912.method7790(this.field1643 >> 16 & 0xFFFF, this.field1643 & 0xFFFF);
        class556 class5562 = new class556(byArray);
        int n2 = class5562.method10282();
        int n3 = class5562.method10307();
        byte[] byArray2 = bl ? class3913.method7736(0, n3) : class3913.method7736(n3, 0);
        this.field1641 = new class186(n3, byArray2);
        this.field1645 = new ArrayList();
        this.field1640 = class299.field3245.submit(new class143(this, class5562, n2));
    }

    @ObfuscatedName(value="ah")
    @ObfuscatedSignature(descriptor="(Lvy;IS)V", garbageValue="6837")
    void method3520(class556 class5562, int n) {
        class5562.method10307();
        class5562.method10307();
        this.field1642 = class5562.method10282();
        ...
        while (true) {
            ...
            if (n3 >= n2) {
                ...
                for (int i = 0; i < class142.field1631; ++i) {
                    ...
                    n4 = n5;
                    int n8 = n7;
                    this.field1645.add(class299.field3245.submit(new class139(this, n4, n8, class135Array)));
                }
                return;
            }
            class137 class1372 = class64.method1253(class5562.method10282());
            n5 = class5562.method10294();
            class138 class1382 = class538.method10069(class5562.method10282());
            class136 class1362 = new class136();
            class1362.method3447(class5562, n);
    ...
    void method3525(class428 class4282, int n, class133 class1332, int n2) {
        ...
        class428 class4283 = class293.method6389();
