...
public class class52 {
    ...
    class52() {
        ...
        this.field331 = class602.method1205(24);
        this.field332 = new int[this.field331];
        boolean bl2 = bl = class602.method1207() != 0;
        if (!bl) {
            n4 = class602.method1207() != 0 ? 1 : 0;
            for (n3 = 0; n3 < this.field331; ++n3) {
                this.field332[n3] = n4 != 0 && class602.method1207() == 0 ? 0 : class602.method1205(5) + 1;
            }
        } else {
            n4 = 0;
            n3 = class602.method1205(5) + 1;
            while (n4 < this.field331) {
                int n5 = class602.method1205(class320.method6612(this.field331 - n4));
                for (n2 = 0; n2 < n5; ++n2) {
                    this.field332[n4++] = n3;
                }
                ++n3;
        ...
        if (n4 <= 0) return;
        float f = class54.method1155(class602.method1205(32));
        float f2 = class54.method1155(class602.method1205(32));
        n2 = class602.method1205(4) + 1;
        boolean bl3 = class602.method1207() != 0;
        int n6 = n4 == 1 ? class52.method1108(this.field331, this.field333) : this.field331 * this.field333;
        this.field334 = new int[n6];
        for (n = 0; n < n6; ++n) {
            this.field334[n] = class602.method1205(n2);
        }
        this.field335 = new float[this.field331][this.field333];
        if (n4 != 1) {
            for (n = 0; n < this.field331; ++n) {
                float f3 = 0.0f;
    ...
    @ObfuscatedName(value="ah")
    void method1115() {
        int[] nArray = new int[this.field331];
                ...
                block14: {
                    ...
                    block15: {
                        ...
                        block10: {
                            block13: {
                                block11: {
                                    if (n >= this.field331) break block10;
                                    n8 = this.field332[n];
                        ...
                        block1: while (true) {
                            ...
                            while (true) {
                                    ...
                                    block21: {
                                        block22: {
                                            block19: {
                                                ...
                                                if (this.field336[n5] != 0) break block21;
                                                break block22;
                                            }
                                            ++n5;
                                            break block23;
                                ...
                                if (n5 >= this.field336.length) {
                                    int[] nArray3 = new int[this.field336.length * 2];
                                    for (n6 = 0; n6 < this.field336.length; ++n6) {
                                        nArray3[n6] = this.field336[n6];
                                    }
                                    this.field336 = nArray3;
                                }
                                n3 >>>= 1;
                                ++n4;
                            }
    ...
    int method1110(class60 class602) {
        int n = 0;
        while (this.field336[n] >= 0) {
            n = class602.method1207() != 0 ? this.field336[n] : n + 1;
        }
        return ~this.field336[n];
    }
    ...
    @ObfuscatedName(value="ay")
    static int method1108(int n, int n2) {
