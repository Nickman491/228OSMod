...
public class class228 {
    ...
    public class228(int n) {
        ...
        if (itemComposition.method5611()) {
            this.field2479 = new short[itemComposition.recolorTo.length];
            System.arraycopy(itemComposition.recolorTo, 0, this.field2479, 0, this.field2479.length);
        }
        if (itemComposition.method5579()) {
            this.field2477 = new short[itemComposition.retextureTo.length];
            System.arraycopy(itemComposition.retextureTo, 0, this.field2477, 0, this.field2477.length);
        }
        this.field2474 = itemComposition.model;
    }
    ...
    public static boolean method5106(int n) {
        return n == WorldMapDecorationType.field4088.id;
    }
    ...
    static final void method5107(int n, int n2, int n3, int n4, int n5, int n6) {
        ...
        int n16 = n6 * n13 >> 17;
        int n17 = n6 * n13 + 1 >> 17;
        int n18 = (n -= Rasterizer2D.Rasterizer2D_xClipStart) + n14;
        int n19 = n - n15;
        int n20 = n + n9 - n15;
        int n21 = n + n14 + n9;
        int n22 = n16 + (n2 -= Rasterizer2D.Rasterizer2D_yClipStart);
        int n23 = n2 - n17;
        int n24 = n7 + n2 - n17;
        int n25 = n7 + n16 + n2;
        SceneTileModel.method4021(n18, n19, n20);
        SceneTileModel.method4009(n22, n23, n24, n18, n19, n20, 0.0f, 0.0f, 0.0f, n5);
        SceneTileModel.method4021(n18, n20, n21);
        SceneTileModel.method4009(n22, n24, n25, n18, n20, n21, 0.0f, 0.0f, 0.0f, n5);
    }
}
