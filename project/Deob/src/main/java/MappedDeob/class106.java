...
public class class106 {
    ...
    static void method3078() {
        if (class544.clientPreferences.method2887()) {
            UserComparator3.method3347(0, 0);
        } else {
            ArrayList<class345> arrayList = new ArrayList<class345>();
            arrayList.add(new class345((AbstractArchive)class544.field5399, "scape main", "", 255, false));
    ...
    static void method3077(Widget widget) {
        widget.importIndex();
        widget.method7444().method7176(new class110(widget));
        widget.method7444().method7175(new class111(widget));
    }
}
