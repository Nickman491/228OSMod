...
public class LoginScreenAnimation {
    ...
    @ObfuscatedGetter(intValue=-1698540164)
    int field1295 = 0;
    ...
    LoginScreenAnimation(IndexedSprite[] indexedSpriteArray, int[][] nArray) {
        this.sprites = indexedSpriteArray;
    ...
    final void method2862(int n) {
        ...
        if (this.field1294 > this.field1292.length) {
            ...
            this.method2844(this.sprites[n2]);
        }
        n2 = 0;
        int n3 = n * 128;
        int n4 = (256 - n) * 128;
            ...
            if (n5 >= n4) {
                ...
                while (true) {
                    ...
                    if (n7 >= 256) {
                        ...
                        while (true) {
                            if (n7 >= 256) {
                                this.field1295 = this.field1295 * 10000 + 100 * n;
                                n7 = ((Client.cycle & 1) + n) / 2;
                                if (n7 <= 0) return;
                                n10 = 128;
                                n9 = 2;
                                n8 = 128 - n9 - n9;
    ...
    final void method2843(int n) {
        ...
        block0: while (n3 < 255) {
            ...
            if (n5 + 128 >= class6.rasterProvider.width) {
                n7 = class6.rasterProvider.width - n5;
            }
            int n8 = n5 + (n3 + 8) * class6.rasterProvider.width;
            n2 += n6;
            int n9 = n6;
            while (true) {
                if (n9 >= n7) {
                ...
                int n11 = n8 % Rasterizer2D.Rasterizer2D_width;
                if (n10 != 0 && n11 >= Rasterizer2D.Rasterizer2D_xClipStart && n11 < Rasterizer2D.Rasterizer2D_xClipEnd) {
                    int n12 = n10;
                    int n13 = 256 - n10;
                    n10 = this.field1301[n10];
                    int n14 = class6.rasterProvider.pixels[n8];
                    class6.rasterProvider.pixels[n8++] = 0xFF000000 | (n12 * (n10 & 0xFF00) + n13 * (n14 & 0xFF00) & 0xFF0000) + ((n10 & 0xFF00FF) * n12 + (n14 & 0xFF00FF) * n13 & 0xFF00FF00) >> 8;
                } else {
                    ++n8;
                }
                ++n9;
    ...
    final void method2844(IndexedSprite indexedSprite) {
        int n;
        ...
        while (true) {
            ...
            if (n >= 5000) {
                ...
                block2: while (true) {
                    ...
                    int n4;
                    if (n >= 20) {
                        if (indexedSprite == null) return;
                        n = 0;
                        n2 = 0;
                        while (true) {
                            if (n2 >= indexedSprite.subHeight) {
                                return;
                            }
                            for (n4 = 0; n4 < indexedSprite.subWidth; ++n4) {
                                if (indexedSprite.pixels[n++] == 0) continue;
                                n3 = n4 + indexedSprite.xOffset + 16;
                                int n5 = n2 + indexedSprite.yOffset + 16;
                                int n6 = n3 + (n5 << 7);
                                this.field1292[n6] = 0;
                            }
                            ++n2;
    ...
    static boolean method2876() {
        return class544.clientPreferences.method2904() >= Client.field766;
    }
}
