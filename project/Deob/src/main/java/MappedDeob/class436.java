...
public class class436 {
    ...
    public void method8534(int n) {
        if (this.field4801 != null && n < this.field4801.ascent * 2) {
            n = Integer.MAX_VALUE;
        }
        if (this.field4804 != n) {
            this.field4804 = n;
    ...
    public void method8663(AbstractFont abstractFont) {
        if (abstractFont != this.field4801) {
            this.field4801 = abstractFont;
    ...
    public int method8555() {
        return this.method8579() ? 0 : this.field4801.ascent + ((class438)this.field4811.get((int)(this.field4811.size() - 1))).field4822;
    }
    ...
    int method8576(class438 class4382, boolean bl) {
        ...
        int n = this.field4801.advances[class4382.field4824];
        if (n != 0) {
            return n;
        }
        if (class4382.field4824 != '\t') {
            return this.field4801.advances[32];
        }
        return this.field4801.advances[32] * 3;
    }
