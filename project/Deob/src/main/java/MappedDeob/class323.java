...
public class class323 {
    ...
    static boolean method6619(int n, int n2, int n3, int n4, int n5, int n6, int n7) {
                ...
                block22: {
                    ...
                    if (n6 != class384.field4494.field4495) {
                        if (n6 != class384.field4496.field4495) {
                            ...
                            if (n4 == WorldMapDecorationType.field4082.id) {
                                n4 = WorldMapDecorationType.field4086.id;
                            }
                            if (class2092 != null) {
                        ...
                        if (class2082 != null) {
                            ...
                            if (n4 != WorldMapDecorationType.field4071.id && n4 != WorldMapDecorationType.field4072.id) {
                                if (n4 != WorldMapDecorationType.field4069.id) {
                                    if (n4 != WorldMapDecorationType.field4090.id) {
                                        if (n4 == WorldMapDecorationType.field4075.id) {
        ...
        if (n4 != WorldMapDecorationType.field4070.id) {
