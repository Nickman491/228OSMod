...
@Implements(value="GraphicsDefaults")
public class GraphicsDefaults {
    ...
    @Export(value="decode")
    public void decode(AbstractArchive abstractArchive) {
        byte[] byArray = abstractArchive.takeFileFlat(DefaultsGroup.field5097.group);
                ...
                case 3: {
                    for (int i = 0; i < this.field5101.length; ++i) {
                        for (int j = 0; j < this.field5101[i].length; ++j) {
                            this.field5101[i][j] = buffer.readMedium();
                        }
                    }
                    continue block5;
                }
                case 2: {
                    this.field5116 = buffer.method10476();
                    this.field5106 = buffer.method10476();
                    this.field5102 = buffer.method10476();
                    this.field5103 = buffer.method10476();
                    this.field5104 = buffer.method10476();
                    this.field5105 = buffer.method10476();
                    this.field5108 = buffer.method10476();
                    this.field5107 = buffer.method10476();
                    this.field5100 = buffer.method10476();
                    this.field5109 = buffer.method10476();
                    this.field5110 = buffer.method10476();
                    break;
                }
                case 1: {
                    buffer.readMedium();
    ...
    public static void method9495(AbstractArchive abstractArchive) {
        DbRowType.field5417 = abstractArchive;
    }
}
