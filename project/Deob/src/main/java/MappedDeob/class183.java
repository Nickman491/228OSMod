...
extends class195 {
    ...
    class183(int n, int n2, int n3, int n4, int n5, int n6, int n7) {
        ...
        this.field1974 = n4;
        this.field1965 = n5;
        this.field1961 = SceneTileModel.field1954[n4];
        this.field1967 = SceneTileModel.Rasterizer3D_cosine[n4];
        this.field1968 = SceneTileModel.field1954[n5];
        this.field1969 = SceneTileModel.Rasterizer3D_cosine[n5];
        this.field1970 = n6;
        this.field1971 = n7;
    }
    ...
    void vmethod4503(Renderable renderable, int n, int n2, int n3, int n4, long l) {
        renderable.vmethod4616(n, this.field1974, this.field1965, n2, n3, n4, this.field1964, this.field1962, this.field1963, l, this.field1970, this.field1971, false);
    }
    ...
    void vmethod4516(class187 class1872, class196 class1962, int n, int n2) {
        ...
        while (true) {
            ...
            class196.field2173[n4] = SceneTileModel.method4008() + n5 * SceneTileModel.method4061() / n7;
    ...
    public static HitSplatDefinition method4104(int n) {
        HitSplatDefinition hitSplatDefinition = (HitSplatDefinition)HitSplatDefinition.HitSplatDefinition_cached.get(n);
        if (hitSplatDefinition != null) {
            return hitSplatDefinition;
        }
        byte[] byArray = HitSplatDefinition.HitSplatDefinition_archive.takeFile(32, n);
        hitSplatDefinition = new HitSplatDefinition();
        if (byArray != null) {
            hitSplatDefinition.decode(new Buffer(byArray));
        }
        HitSplatDefinition.HitSplatDefinition_cached.put(hitSplatDefinition, n);
        return hitSplatDefinition;
    }
}
