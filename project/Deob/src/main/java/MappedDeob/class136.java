...
public class class136 {
    ...
    int method3447(Buffer buffer, int n) {
        int n2 = buffer.readUnsignedShort();
        class142.method3513(buffer.readUnsignedByte());
        this.field1572 = AbstractByteArrayCopier.method7582(buffer.readUnsignedByte());
        this.field1574 = AbstractByteArrayCopier.method7582(buffer.readUnsignedByte());
        this.field1593 = buffer.readUnsignedByte() != 0;
        this.field1573 = new class131[n2];
        class131 class1312 = null;
        int n3 = 0;
        while (n3 < n2) {
            class131 class1313 = new class131();
            class1313.method3375(buffer, n);
    ...
    public static void method3476(AbstractArchive abstractArchive, AbstractArchive abstractArchive2, boolean bl) {
        ObjectComposition.ObjectDefinition_archive = abstractArchive;
        ObjectComposition.ObjectDefinition_modelsArchive = abstractArchive2;
        ObjectComposition.ObjectDefinition_isLowDetail = bl;
    }
}
