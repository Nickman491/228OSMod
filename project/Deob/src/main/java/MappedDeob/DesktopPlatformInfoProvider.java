...
implements class517 {
    ...
    public class516 get() {
        String string;
        String string2;
        int n = Decimator.field379.startsWith("win") ? 1 : (Decimator.field379.startsWith("mac") ? 2 : (Decimator.field379.startsWith("linux") ? 3 : 4));
        try {
    ...
    public static void method9651(int[] nArray, int[] nArray2, int n, int n2) {
        ...
        while (true) {
            if (n8 >= n2) {
                ...
                nArray2[n4] = n6;
                DesktopPlatformInfoProvider.method9651(nArray, nArray2, n, n4 - 1);
                DesktopPlatformInfoProvider.method9651(nArray, nArray2, n4 + 1, n2);
                return;
            }
