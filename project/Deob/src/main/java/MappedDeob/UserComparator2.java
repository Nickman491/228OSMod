...
@Implements(value="UserComparator2")
...
implements Comparator {
    ...
    public UserComparator2(boolean bl) {
        this.reversed = bl;
    }
    ...
    int compare_bridged(User user, User user2) {
        return this.reversed ? user.getUsername().compareToTyped(user2.getUsername()) : user2.getUsername().compareToTyped(user.getUsername());
    }
