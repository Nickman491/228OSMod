...
implements class311 {
    ...
    protected class309(StudioGame studioGame, Language language, int n) {
        this.field3286 = n;
    }

    @ObfuscatedName(value="ay")
    @ObfuscatedSignature(descriptor="(B)[Lvb;", garbageValue="16")
    @Export(value="FillMode_values")
    public static class568[] FillMode_values() {
        return new class568[]{class568.field5555, class568.SOLID, class568.field5556};
    }
