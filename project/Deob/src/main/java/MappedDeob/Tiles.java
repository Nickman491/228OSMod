...
public final class Tiles {
    ...
    @Export(value="Tiles_minPlane")
    static int Tiles_minPlane = 99;
    @ObfuscatedName(value="ao")
    @Export(value="Tiles_shapes")
    static byte[][][] Tiles_shapes;
    @ObfuscatedName(value="ad")
    static byte[][][] field1026;
    @ObfuscatedName(value="an")
    @Export(value="Tiles_underlays2")
    static byte[][][] Tiles_underlays2;
    @ObfuscatedName(value="at")
    @Export(value="Tiles_saturation")
    static int[] Tiles_saturation;
    @ObfuscatedName(value="ac")
    @Export(value="Tiles_lightness")
                                        ...
                                        if (n != 1) {
                                            ...
                                            while (true) {
                                                if (n4 > n) {
                                                    ...
                                                    int n5 = Tiles.method2556(fArray4, n - 1, f, false, f2, false, fArray5);
                                                    if (n5 != -1) {
                                                        boolean bl4 = false;
                                                        float f5 = 0.0f;
                                                        float f6 = 0.0f;
    ...
    static final void method2511(class103 class1032, byte[] byArray, int n, int n2, int n3, int n4, int n5, int n6, int n7) {
        ...
        int n8 = -1;
        int n9;
        block0: while ((n9 = buffer.method10297()) != 0) {
            n8 += n9;
            int n10 = 0;
            while (true) {
                int n11;
                if ((n11 = buffer.readUShortSmart()) == 0) continue block0;
                ...
                ObjectComposition objectComposition = class142.getObjectDefinition(n8);
                int n18 = n2 + class133.method3426(n13 & 7, n12 & 7, n7, objectComposition.sizeX, objectComposition.sizeY, n17);
                int n19 = n3 + class224.method5045(n13 & 7, n12 & 7, n7, objectComposition.sizeX, objectComposition.sizeY, n17);
                ...
                if (n20 >= 0 && class1032.field1336 != null) {
                    collisionMap = class1032.field1336[n20];
                }
                WorldMapSection1.method6435(class1032, n, n18, n19, n8, n17 + n7 & 3, n16, collisionMap);
            }
            break;
        }
        return;
    ...
    static void method2574(String string, String string2, String string3) {
        Varcs.method3212(7);
        class150.setLoginResponseString(string, string2, string3);
    }

    @ObfuscatedName(value="bg")
    @ObfuscatedSignature(descriptor="(ILdm;ZB)I", garbageValue="-95")
    static int method2544(int n, Script script, boolean bl) {
        if (n != ScriptOpcodes.LOGOUT) {
            return 2;
        }
