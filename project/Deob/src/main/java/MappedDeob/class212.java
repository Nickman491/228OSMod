...
public class class212 {
    ...
    public boolean method4862(String string, String string2, UrlRequester urlRequester) {
        ...
        try {
            ...
            this.field2367 = urlRequester.request(new URL(this.field2359));
            this.field2368 = 0;
        }
    ...
    public void method4843(UrlRequester urlRequester) {
        switch (this.field2368 * 1910697539) {
            case 0: {
                this.method4855(urlRequester);
                break;
            }
            default: {
                return;
    ...
    void method4855(UrlRequester urlRequester) {
        if (this.field2367 == null || !this.field2367.isDone()) {
            return;
        }
        byte[] byArray = this.field2367.getResponse();
        if (byArray == null) {
            this.method4854();
            this.field2368 = -1452721748;
            return;
        ...
        try {
            ...
            if (this.field2354 < 2) {
                if (!this.field2369.method5007(jSONObject, this.field2354, urlRequester)) {
                    this.field2368 = -31598974;
                }
            } else if (this.field2354 == 2) {
                class225 class2252;
                class225 class2253 = class2252 = class225.field2458;
                class2253.method5051(jSONObject, this.field2354, urlRequester);
    ...
    void method4872() {
        ...
        do {
            if (!iterator.hasNext()) {
                ...
                } while (class2132.field2373 == null || (byArray = class2132.field2373.getResponse()) == null || byArray.length <= 0);
                this.field2368 = 1421122774;
                return;
            }
            class2132 = (class213)iterator.next();
        } while (class2132.field2373 == null || class2132.field2373.isDone());
    }

    @ObfuscatedName(value="av")
    @ObfuscatedSignature(descriptor="(Ljava/lang/String;Lez;I)Z", garbageValue="2043188933")
    public boolean method4857(String string, UrlRequester urlRequester) {
        try {
    ...
    @Export(value="resumePauseWidget")
    static void resumePauseWidget(int n, int n2) {
        PacketBufferNode packetBufferNode = ScriptEvent.getPacketBufferNode(ClientPacket.field3335, Client.packetWriter.isaacCipher);
        packetBufferNode.packetBuffer.method10333(n);
        packetBufferNode.packetBuffer.writeInt(n2);
