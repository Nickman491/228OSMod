...
public class Huffman {
        ...
        block0: while (n3 < n) {
            ...
            while (true) {
                    ...
                    block17: {
                        block18: {
                            block15: {
                                ...
                                if (this.keys[n5] != 0) break block17;
                                break block18;
                            }
                            ++n5;
                            break block19;
                ...
                if (n5 >= this.keys.length) {
                    int[] nArray2 = new int[this.keys.length * 2];
                    for (int i = 0; i < this.keys.length; ++i) {
                        nArray2[i] = this.keys[i];
                    }
                    this.keys = nArray2;
                }
                n6 >>>= 1;
    ...
    @Export(value="compress")
    int compress(byte[] byArray, int n, int n2, byte[] byArray2, int n3) {
        int n4 = 0;
        int n5 = n3 << 3;
        n2 += n;
        while (n < n2) {
            int n6 = byArray[n] & 0xFF;
            int n7 = this.masks[n6];
            byte by = this.bits[n6];
            if (by == 0) {
    ...
    int decompress(byte[] byArray, int n, byte[] byArray2, int n2, int n3) {
        if (n3 == 0) {
            return 0;
        }
        int n4 = 0;
                                ...
                                block10: {
                                    block9: {
                                        block8: {
                                            block7: {
                                                block5: {
                                                    n4 = (by = byArray[n5]) < 0 ? this.keys[n4] : ++n4;
                                                    n6 = this.keys[n4];
