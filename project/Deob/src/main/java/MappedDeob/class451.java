...
public class class451 {
    ...
    @Export(value="writeRandomDat")
    public static void writeRandomDat(byte[] byArray, int n, byte[] byArray2, int n2, int n3) {
        if (byArray2 == byArray) {
            if (n2 == n) {
                return;
            }
    ...
    public static void clearIntArray(int[] nArray, int n, int n2) {
        n2 = n2 + n - 7;
        while (true) {
            if (n >= n2) {
                n2 += 7;
