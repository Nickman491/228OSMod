...
extends Node {
    ...
    void read(byte[] byArray) {
        ...
        this.sampleRate = buffer.readInt();
        this.sampleCount = buffer.readInt();
        ...
        while (n2 < n) {
            ...
            buffer.readBytes(byArray2, 0, n4);
    ...
    float[] method1137(int var1_1) {
        ...
        this.field367 = new float[VorbisSample.field352];
        var2_2.method1207();
        var3_3 = var2_2.method1205(class320.iLog(VorbisSample.field355.length - 1));
        var4_4 = VorbisSample.field354[var3_3];
        var5_5 = var4_4 != false ? VorbisSample.field352 : VorbisSample.field346;
        var6_6 = false;
        var7_7 = false;
        if (var4_4) {
        ...
        var8_8 = var5_5 >> 1;
        if (var4_4 && !var6_6) {
            var9_9 = (var5_5 >> 2) - (VorbisSample.field346 >> 2);
            var10_10 = (VorbisSample.field346 >> 2) + (var5_5 >> 2);
            var11_11 = VorbisSample.field346 >> 1;
        } else {
            var9_9 = 0;
            var10_10 = var8_8;
            var11_11 = var5_5 >> 1;
        ...
        if (var4_4 && !var7_7) {
            var12_12 = var5_5 - (var5_5 >> 2) - (VorbisSample.field346 >> 2);
            var13_13 = (VorbisSample.field346 >> 2) + (var5_5 - (var5_5 >> 2));
            var14_14 = VorbisSample.field346 >> 1;
        } else {
            var12_12 = var8_8;
            var13_13 = var5_5;
            var14_14 = var5_5 >> 1;
        }
        var15_15 = VorbisSample.field353[VorbisSample.field355[var3_3]];
        var16_16 = var15_15.field328;
        var17_17 = var15_15.field329[var16_16];
        var18_18 = VorbisSample.field341[var17_17].method787(var2_2);
            ...
            block43: {
                block42: {
                    ...
                    if (var18_18.method1199()) {
                        ...
                        var43_27 = var4_4 != false ? VorbisSample.field365 : VorbisSample.field350;
                        var25_28 = var4_4 != false ? VorbisSample.field348 : VorbisSample.field349;
                        var26_29 = var4_4 != false ? VorbisSample.field362 : VorbisSample.field364;
                        var27_30 = var4_4 != false ? VorbisSample.field369 : VorbisSample.field368;
                        var28_31 = 0;
                        while (true) {
                            if (var28_31 >= var21_23) {
                                ...
                                while (true) {
                                    if (var28_31 >= var22_24) {
                                        var28_31 = class320.iLog(var5_5 - 1);
                                        var29_33 = 0;
                                        while (true) {
...
lbl210:
            ...
            var45_21 = VorbisSample.field366[var15_15.field327[var20_20]];
    ...
    RawSound toRawSound(int[] nArray) {
        ...
        block0: while (true) {
            if (this.field372 >= this.field351.length) {
                ...
                this.samples = null;
                return new RawSound(this.sampleRate, byArray, this.start, this.end, this.field342);
            }
            if (nArray != null && nArray[0] <= 0) {
                return null;
            }
                        ...
                        block9: {
                            ...
                            block10: {
                                ...
                                block8: {
                                    ...
                                    n4 = fArray.length;
                                    n3 = this.field371;
                                    if (n4 > this.sampleCount - n3) {
                                        n4 = this.sampleCount - n3;
                                    }
                                    n2 = 0;
                                }
    ...
    static void method1158(byte[] byArray) {
        ...
        block0: while (true) {
            ...
            if (n >= 2) {
                ...
                field363 = new VorbisCodebook[n];
                for (n5 = 0; n5 < n; ++n5) {
                    VorbisSample.field363[n5] = new VorbisCodebook();
                }
                ...
                n5 = class602.method1205(6) + 1;
                field341 = new VorbisFloor[n5];
                for (n4 = 0; n4 < n5; ++n4) {
                    VorbisSample.field341[n4] = new VorbisFloor();
                }
                n4 = class602.method1205(6) + 1;
                field366 = new class46[n4];
                for (n3 = 0; n3 < n4; ++n3) {
                    VorbisSample.field366[n3] = new class46();
                }
                n3 = class602.method1205(6) + 1;
                field353 = new VorbisMapping[n3];
                for (n2 = 0; n2 < n3; ++n2) {
                    VorbisSample.field353[n2] = new VorbisMapping();
                }
                ...
                while (true) {
                    ...
                    VorbisSample.field354[n6] = class602.method1207() != 0;
                    class602.method1205(16);
                    class602.method1205(16);
                    VorbisSample.field355[n6] = class602.method1205(8);
                    ++n6;
                }
            }
    ...
    static boolean method1144(AbstractArchive abstractArchive) {
        if (!field356) {
            byte[] byArray = abstractArchive.takeFile(0, 0);
            if (byArray == null) {
                return false;
            }
            VorbisSample.method1158(byArray);
            field356 = true;
        }
        return true;
    }
    ...
    static VorbisSample readMusicSample(AbstractArchive abstractArchive, int n, int n2) {
        if (VorbisSample.method1144(abstractArchive)) {
            byte[] byArray = abstractArchive.takeFile(n, n2);
            if (byArray == null) {
                return null;
            }
            return new VorbisSample(byArray);
        }
        abstractArchive.tryLoadFile(n, n2);
        return null;
    }
}
