...
extends class448 {
    ...
    public class450(class448 class4482, AbstractArchive abstractArchive, AbstractArchive abstractArchive2, AbstractArchive abstractArchive3) {
        super(class4482);
        this.field4875 = abstractArchive;
        this.field4874 = abstractArchive2;
        this.field4873 = abstractArchive3;
        ...
        for (class345 class3452 : class333.field3623) {
            ...
            try {
                ...
                if (class3452.field3747 == null) {
                    class3452.field3747 = MusicTrack.readTrack(class3452.field3736, class3452.field3735, class3452.field3737);
                    if (class3452.field3747 == null) continue;
                }
                if (class3452.field3746 == null) {
                    class3452.field3746 = new SoundCache(this.field4873, this.field4874);
                }
